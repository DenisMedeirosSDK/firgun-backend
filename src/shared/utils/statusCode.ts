...
// const normalized = (name: string) => name.toUpperCase().replace(/\s/g, "_");

// const statusCode = Object.keys(STATUS_CODES)
//   .map((code) => ({
//     [normalized(STATUS_CODES[code] + `_${code}`)]: parseInt(code),
//   }))
...
export const STATUS_CODES = {
  ...
  CREATED_201: 201,
  ACCEPTED_202: 202,
  'NON-AUTHORITATIVE_INFORMATION_203': 203,
  NO_CONTENT_204: 204,
  RESET_CONTENT_205: 205,
  PARTIAL_CONTENT_206: 206,
  'MULTI-STATUS_207': 207,
